...
function newPost() {
    ...
    var postHtml = '<div class="post-form"> <div class="card card-formPost"> <form id="formTest" name="formPost"> <div class="card-header"> <img src="img/pfp/avatar.jpg" class="card-avatar" placeholder="Avatar user" /> <span class="username-post">Manuel210992</span> <div class="post-info"></div> </div> <label><h2>Titre de votre poste</h2>  </label> <div class="input-form-wrapper"> <input type="text" name="post-headline" /> </div> <label><h3>Message</h3>  </label> <div class="input-form-wrapper"> <input type="text" name="post-message" /> </div> <div id="drop-region"> <h2 id="drop-file-text">Click here to upload your files</h2> <div class="drop-message m-5"> <svg version="1.1" id="add-image" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="56.513px" height="56.513px" viewBox="0 0 316.513 316.513" style="enable-background: new 0 0 316.513 316.513" xml:space="preserve" > <defs> <linearGradient id="gradient"> <stop offset="0%" stop-color="rgba(255,162,109,1)" /> <stop offset="10%" stop-color="rgba(255,162,109,1)" /> <stop offset="37%" stop-color="rgba(223,211,34,1)" /> <stop offset="102%" stop-color="rgba(226,161,31,1)" /> </linearGradient> </defs> <g> <path fill="url(#gradient)" d="M158.253,0C71,0,0.012,71.001,0.012,158.263c0,87.256,70.989,158.25,158.241,158.25 c87.259,0,158.248-70.994,158.248-158.25C316.501,71.001,245.518,0,158.253,0z M230.891,177.982h-57.748v52.914 c0,7.428-4.864,13.438-12.301,13.438c-7.422,0-12.298-6.017-12.298-13.438v-52.914H85.634c-7.44,0-13.454-4.864-13.454-12.298 s6.014-12.301,13.454-12.301h62.909V85.616c0-7.434,4.876-13.453,12.298-13.453c7.437,0,12.301,6.02,12.301,13.453v67.768h57.748 c7.439,0,13.456,4.867,13.456,12.301S238.33,177.982,230.891,177.982z" /> </g> </svg> </div> <div id="image-preview"></div> </div> <hr class="sep sep-form"> <h4 class="text-post-form">  <label class="blanc button px-2"> Date de l&#039évènement <div class="input-form-wrapper"> <input id="event" type="date" name="date-event" required> </div> </label> <hr class="sep sep-form"> <h4 class="text-post-form">  <label class="blanc button px-2"> Lieu de l&#039évènement <div class="input-form-wrapper"> <input id="location" type="text" name="location-event" required> </div> </label> </h2> <button class="btn p-1" type="submit" id="submit-post">Submit</button> </form> </div> </div>';
