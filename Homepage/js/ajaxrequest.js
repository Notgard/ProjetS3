...
function AjaxRequest(config) {
    ...
    requestThis.transport.onreadystatechange = function() {
////////////////////////////////////////////////////////////////////////////////
// A ECRIRE
        ...
        if (requestThis.transport.readyState == 4) {
            ...
            if (requestThis.transport.status == 200) {
                ...
                var status = requestThis.transport.status;
                var content = requestThis.transport.responseText;
                requestThis.onError(status, content);
            }
        }
    }
    ...
    for (let i in this.parameters) {
        ...
        var parameter_escaped = i+"="+encodeURIComponent(this.parameters[i]);
        parameters.push(parameter_escaped);
////////////////////////////////////////////////////////////////////////////////
// A ECRIRE
    }
...
// A ECRIRE
        // Open transport
        requestThis.transport.open('POST', this.url, true);
        // Set content type request header
        requestThis.transport.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
