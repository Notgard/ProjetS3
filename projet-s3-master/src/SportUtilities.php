...
<div class="d-flex flex-row flex-grow-1 mb-4 p-2 w-100 main-bar sticky-top">
	...
	<form method="GET" id="formSearch" style="display:inline;">
		<input name="search" placeholder="Search" type="text" id="header-searchbar" class="searchbar" value="$search">
	</form>
	<svg id="searchIcon" width="30" height="30" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" class="header-svg-search">
	...
	<svg onclick="window.location.href = 'message.php';" width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="header-svg-messages">
...
HTML;
	...
	public static function getPublications(string $search = "") : string {
		$stmtEvenement = MyPDO::getInstance()->prepare(<<<SQL
SELECT e.idPublication, idImage, idUser, dateDePublication, message, isEvent, idEvenement, nbParticipantsMax, nom, lieu, dateEvenement, typeSport
...
SELECT idPublication, p.idImage, p.idUser, dateDePublication, message, isEvent
...
SQL);
	...
	<a class="d-flex flex-column scroll-item m-3" href="profil.php?user=$login">
		<img src="getImage.php?idImage=$idImage" style="height:100px;" class="mx-auto">
